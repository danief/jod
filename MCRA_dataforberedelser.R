#---------------------------------------------------------------------
#
# Forberedelse av kostholdsundersokelse data  
...
head(c[,1:3])
dim(c) # 1787 observasioner fordelt p?  1118 variabler
#---------------------------------------------------------------------
# bytt komma med dot
...
head(t, 50)
dim(t) # 1994292 observasioner fordelt p?  4 variabler
...
head(t)
str(t)
dim(t) # 64173 observasioner fordelt p?  4 variabler
#---------------------------------------------------------------------
